...
export default function Testemunhas() {
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 bg-white rounded-xl shadow-lg relative h-48 overflow-hidden mt-20 mb-40">
            <AnimatePresence>
                <motion.div
            ...
            <button
                onClick={prev}
                aria-label="Previous"
                className=" cursor-pointer absolute top-1/2 left-4 -translate-y-1/2 bg-cyan-700 hover:bg-cyan-900 text-white rounded-full w-10 h-10 flex items-center justify-center">
                ‹
            </button>
            <button
                onClick={next}
                aria-label="Next"
                className="cursor-pointer absolute top-1/2 right-4 -translate-y-1/2 bg-cyan-700 hover:bg-cyan-900 text-white rounded-full w-10 h-10 flex items-center justify-center">›
            </button>
        </div>
    );
}
